...
public class SnmpData {
    ...
    private static Logger LOGGER = LogManager.getLogger(SnmpData.class);
    ...
    public static void snmpGet(String ip, String community, String oid) {
        ...
        try {
            ...
            if (response == null) {
                LOGGER.info("-------> response is null, request time out <-------" + ip);
            } else {
                LOGGER.info(ip + "response pdu size is " + response.size());
                LOGGER.info(ip + "response pdu size is " + response);
            ...
            e.printStackTrace();
            LOGGER.error(ip + "SNMP Get Exception:" + e);
        } finally {
            if (snmp != null) {
                try {
                    snmp.close();
    ...
    public static void main(String[] args) {
        snmpGet("127.0.01","public",".1.3.6.1.2.1.1.1.0");
        //
